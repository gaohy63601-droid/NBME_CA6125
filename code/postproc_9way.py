"""Per-case postproc on top of 9-way per-case best masks. Reads per_case_9way_dump.npz."""
import os, ast
import numpy as np
...
dump = np.load(os.path.join(PRED_DIR_MS, "per_case_9way_dump.npz"), allow_pickle=True)
...
print(f"\n[9-WAY + per-case postproc OVERALL] F1 = {f1(gms, overall):.4f}")
print(f"\nbaseline:  7-way + postproc:  0.8788")
